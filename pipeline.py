...
LUA_SHA1 = get_hash(os.path.join(CWD, 'docker.lua'))
...
project = Project(
    ...
    project_html='''
        ...
        <h2>Docker <span class="links"><a href="https://hub.docker.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/docker/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Docker">Wiki</a></span></h2>
        <p>Archiving selected Docker.</p>
    '''
)
